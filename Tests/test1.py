...
class Collider(Wrapper):
    def update(self):
        ...
        if self.overlapping_sprites:
            ...
            self.die()
class ColliderA(Wrapper):
    def update(self):
        super(ColliderA, self).update()
        if self.overlapping_sprites:
...
name = games.Message(value="Metal Fight!",
                             ...
                             lifetime=5 * games.screen.fps,
                             is_collideable=False)
HP1 = games.Text(value=10000,
                 size=60,
                 color=color.white,
                 x=1100,
                 y=30,
                 is_collideable=False)
HP2 = games.Text(value=10000,
                 size=60,
                 color=color.white,
                 x=100,
                 y=30,
...
def main():
    ...
    games.music.load("maintheme2.mp3")
